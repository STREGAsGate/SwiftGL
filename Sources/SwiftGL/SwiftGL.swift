...
//  SwiftGL
//
//  Created by Dustin Collins on 3/25/19.
//
...
public enum OpenGL {
    ...
    public enum Framebuffer {
        public enum Status: Equatable {
            ...
            @usableFromInline static func fromValue(_ value: Int32) -> Status {
                switch value {
        ...
        public enum Target {
            ...
            @usableFromInline var value: Int32 {
                switch self {
                case .draw:
    ...
    public struct Error: Swift.Error, CustomStringConvertible {
        ...
        @usableFromInline internal init(_ kind: Kind, _ function: StaticString, _ possibleReasons: String...) {
            self.kind = kind
        ...
        public enum Kind: Int {
            ...
            @usableFromInline internal static func fromValue(_ value: Int32) -> Kind {
                switch value {
...
@inlinable public func glUniform<T: SignedInteger>(location: GLint, values: [T]) throws {
...
@inlinable public func glUniform<T: UnsignedInteger>(location: GLint, values: [T]) throws {
...
@inlinable public func glUniform(location: GLint, values: [Float]) throws {
    switch values.count {
    case 1:
...
@inlinable public func glBufferData<D>(_ data: [D], withUsage usage: OpenGL.Buffer.Data.Usage, as target: OpenGL.Buffer.Target) {
...
@inlinable public func glViewport<T: BinaryInteger>(x: T, y: T, width: T, height: T) {
